...
export const SERVICES = {
  ...
  schemaAnalyzer: {
    ...
    url: import.meta.env.VITE_SCHEMA_ANALYZER_URL || 'http://localhost:8001',
    healthEndpoint: '/',
    type: 'docker',
  ...
  pycaretEngine: {
    ...
    name: 'PyCaret Engine',
    category: 'AI Services',
    url: import.meta.env.VITE_PYCARET_ENGINE_URL || 'http://localhost:8002',
    healthEndpoint: '/',
    type: 'docker',
  ...
  djangoAI: {
    ...
    category: 'AI Services',
    url: import.meta.env.VITE_DJANGO_AI_URL || 'http://localhost:8000',
  ...
  identityAPI: {
    ...
    url: import.meta.env.VITE_IDENTITY_API_URL || 'http://localhost:5036',
  ...
  catalogAPI: {
    ...
    name: 'Catalog API',
    category: '.NET Microservices',
    url: import.meta.env.VITE_CATALOG_API_URL || 'http://localhost:5280',
    healthEndpoint: '/swagger',
    type: 'dotnet',
  ...
  basketAPI: {
    ...
    name: 'Basket API',
    category: '.NET Microservices',
    url: import.meta.env.VITE_BASKET_API_URL || 'http://localhost:5023',
    healthEndpoint: '/swagger',
    type: 'dotnet',
  ...
  dataAnalysisAPI: {
    ...
    category: '.NET Microservices',
    url: import.meta.env.VITE_DATA_ANALYSIS_API_URL || 'http://localhost:5221',
    healthEndpoint: '/swagger',
    type: 'dotnet',
  ...
  rabbitmq: {
    ...
    url: import.meta.env.VITE_RABBITMQ_URL || 'http://localhost:15672',
    healthEndpoint: null,
    type: 'docker',
    containerName: 'rabbitmq.container',
    port: 15672,
    managementUI: import.meta.env.VITE_RABBITMQ_URL || 'http://localhost:15672',
  ...
  mongodbCatalog: {
    ...
    category: 'Infrastructure',
    url: import.meta.env.VITE_MONGODB_CATALOG_URL || 'mongodb://localhost:27030',
    healthEndpoint: null,
    type: 'docker',
  ...
  mongodbDiscount: {
    ...
    category: 'Infrastructure',
    url: import.meta.env.VITE_MONGODB_DISCOUNT_URL || 'mongodb://localhost:27034',
    healthEndpoint: null,
    type: 'docker',
  ...
  sqlserver: {
    ...
    name: 'SQL Server',
    category: 'Infrastructure',
    url: import.meta.env.VITE_SQLSERVER_URL || 'localhost:1433',
    healthEndpoint: null,
    type: 'docker',
  ...
  keycloak: {
    ...
    port: 8080,
    managementUI: import.meta.env.VITE_KEYCLOAK_URL || 'http://localhost:8080',
  ...
  postgresql: {
    ...
    name: 'PostgreSQL',
    category: 'Infrastructure',
    url: import.meta.env.VITE_POSTGRESQL_URL || 'postgresql://localhost:5432',
    healthEndpoint: null,
    type: 'docker',
  ...
  frontend: {
    ...
    name: 'React Frontend',
    category: 'Frontend',
    url: import.meta.env.VITE_FRONTEND_URL || 'http://localhost:59264',
    healthEndpoint: '/',
    type: 'npm',
  ...
  projectAdmin: {
    ...
    name: 'Project Admin',
    category: 'Frontend',
    url: import.meta.env.VITE_PROJECT_ADMIN_URL || 'http://localhost:59265',
    healthEndpoint: '/',
    type: 'npm',
  ...
  userAdmin: {
    ...
    name: 'User Admin',
    category: 'Frontend',
    url: import.meta.env.VITE_USER_ADMIN_URL || 'http://localhost:59266',
    healthEndpoint: '/',
    type: 'npm',
