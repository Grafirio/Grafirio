...
export async function withDesktopConnectionContext(payload) {
...
export async function requireDesktopSavedConnection(connectionId, readSummary) {
  ...
  if (connection?.connectionMode !== 'bridge' || typeof connection.bridgeId !== 'string') {
    throw new DesktopConnectionError();
  }
