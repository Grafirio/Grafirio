// Marka isareti. Alti radyal dilim, farkli uzunlukta — halka degil, veri
// okumasi. 64px altinda "compact" devreye giriyor: bes esit dilim, daha
// genis agiz. Kucukte alti dilimin kesme bosluklari kapaniyor ve isaret
// lekeye donuyordu (bkz. grifirio.front/src/components/GMark.jsx — ayni
// cizim, iki ayri React projesinde).
//
// Dilim renkleri ve uzunluklari marka kilavuzunda "degistirilmez" olarak
// isaretli; prop olarak disari acilan tek sey G'nin rengi (koyu zeminde
// acik renge doner).
const FULL_SLICES = [
